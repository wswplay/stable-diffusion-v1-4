...
The **Stable-Diffusion-v1-4** checkpoint was initialized with the weights of the [Stable-Diffusion-v1-2](https://huggingface.co/CompVis/stable-diffusion-v1-2/blob/main/v1-variants-scores.jpg) 
